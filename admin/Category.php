...
<head>
  ...
  <link rel="stylesheet" href="assets/css/style.css">
          ...
          <div class="card">
            <div class="card-body  ">
            <h4 class="card-titl h1" style="text-size:60px; text-decoration:bold; color:red; font-family:Helvetica; ">Category Master</h4>
              <a href="mange_category.php" class="text-decoration-none" ><i class="fa fa-plus" aria-hidden="true"></i> &nbsp; Add Category</a>
              <br><br>              
              <div class="row">
                <div class="col-12">
                    ...
                    <table id="order-listing" class="table">
                      ...
                      ?>
                        <tr>
                            ...
                            <td>
								<a href="mange_category.php?id=<?php echo $row['id']?>"><label class="badge badge-success">Edit</label></a>&nbsp;
								<?php
								if($row['status']==1){
								?>
